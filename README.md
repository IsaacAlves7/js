...
Atuo no desenvolvimento de front-end com SPAs (React, Angular, Vue) e SSR com Next.js, criando interfaces responsivas a partir de protótipos Figma (UI/UX) e trabalhando com arquitetura de micro-frontends. No back-end, desenvolvo APIs RESTful e GraphQL, com versionamento em Git e pipelines de CI/CD.
