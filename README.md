...
No front-end, atuo em projetos com SPAs (React, Angular, Vue), SSR (Next.js) e design responsivo com HTML/CSS, Flexbox e CSS Grid, juntamente com consumo de APIs, baseados em protótipos do Figma (UI/UX).
